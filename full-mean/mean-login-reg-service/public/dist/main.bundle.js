...
var routes = [
    ...
    { path: 'index', component: __WEBPACK_IMPORTED_MODULE_3__login_login_component__["a" /* LoginComponent */] }
];
...
var HomeComponent = (function () {
    function HomeComponent(_us, _router) {
        this._us = _us;
    ...
    HomeComponent.prototype.logout = function () {
        var _this = this;
        this._us.logout()
            .then(function (response) { return _this._router.navigateByUrl('/index'); });
    };
